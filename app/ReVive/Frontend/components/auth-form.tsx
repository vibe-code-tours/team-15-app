...
import { applyReferralCode } from "@/app/actions/referrals"
...
function AuthFormInner({ mode }: { mode: "sign-in" | "sign-up" }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isSignUp && referralInput && result.data?.user?.id) {
        await applyReferralCode(referralInput, result.data.user.id)
      }
